...
import uk.gov.hmrc.http.{HeaderCarrier, NotFoundException, ServiceUnavailableException, Upstream4xxResponse, Upstream5xxResponse, UpstreamErrorResponse}
...
class LiveLegacyMobileTaxCreditsRenewalController @Inject() (
  ...
  def addMainApplicantFlag(nino: Nino)(implicit headerCarrier: HeaderCarrier): Future[Result] =
