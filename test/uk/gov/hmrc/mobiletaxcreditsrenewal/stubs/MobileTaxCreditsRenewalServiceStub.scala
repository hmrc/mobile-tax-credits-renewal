...
trait MobileTaxCreditsRenewalServiceStub extends MockFactory {
  ...
  def stubClaimantDetailsResponse(
    ...
    (mobileTaxCreditsRenewalService
      .claimantDetails(_: Nino)(_: HeaderCarrier, _: ExecutionContext))
      .expects(nino, *, *)
  ...
  def stubServiceClaimantClaims(
    ...
    (mobileTaxCreditsRenewalService
      ...
      .expects(nino, *, *)
      .returning(Future successful claims)

  def stubServiceAuthenticateRenewal(
  ...
  def stubEmployedEarningsRti(
    ...
    (mobileTaxCreditsRenewalService
      .employedEarningsRti(_: Nino)(_: HeaderCarrier, _: ExecutionContext))
      .expects(nino, *, *)
